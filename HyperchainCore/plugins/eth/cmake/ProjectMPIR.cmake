...
set_property(TARGET MPIR::mpir PROPERTY IMPORTED_CONFIGURATIONS ${CMAKE_BUILD_TYPE})

#HC
#set_property(TARGET MPIR::mpir PROPERTY IMPORTED_LOCATION_RELEASE ${MPIR_LIBRARY})
set_property(TARGET MPIR::mpir PROPERTY IMPORTED_LOCATION_DEBUG ${MPIR_LIBRARY})
