...
public:
    ...
    virtual bool GetKey(const CKeyID &address, CKey_Secp256k1& key) const { return false; }
...
public:
    ...
    bool GetKey(const CKeyID& keyid, CKey_Secp256k1& key) const override;
...
struct FlatSigningProvider final : public SigningProvider
{
    ...
    std::map<CKeyID, CKey_Secp256k1> keys;
...
{
protected:
    using KeyMap = std::map<CKeyID, CKey_Secp256k1>;
...
public:
    ...
    virtual bool GetKey(const CKeyID &address, CKey_Secp256k1 &keyOut) const override;
